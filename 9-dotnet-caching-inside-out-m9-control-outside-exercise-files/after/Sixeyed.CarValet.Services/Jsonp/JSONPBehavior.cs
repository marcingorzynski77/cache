...
namespace Microsoft.Ajax.Samples
{
    ...
    public class JSONPBehavior : Attribute, IOperationBehavior
    {
        ...
        {
            Trace.WriteLine("ApplyClientBehavior - Adding inspector; callback = " + callback);
            clientOperation.ParameterInspectors.Add(new Inspector(callback));
        }

        public void ApplyDispatchBehavior(OperationDescription operationDescription, DispatchOperation dispatchOperation)
        {
            Trace.WriteLine("ApplyDispatchBehavior - Adding inspector; callback = " + callback);
        ...
        class Inspector : IParameterInspector
        {
            ...
            public object BeforeCall(string operationName, object[] inputs)
            {
                ...
                Trace.WriteLine("BeforeCall - methodName = " + methodName);
